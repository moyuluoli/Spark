...
//        String classPath = Tools.getRootPath();
//        // 组合一个map，把启用的配置，引入的文件组合起来
//        LinkedHashMap<String, Object> mapAll = new LinkedHashMap<>();
//        LinkedHashMap<String, Object> mainMap = yml2Map(classPath + "/" + path);
//        // 读取启用的配置
//        Object active = mainMap.get(this.active);
//        if (!Tools.isBlank(active)) {
//            mapAll.putAll(yml2Map(StrUtil.format("{}/{}-{}.yml", classPath, this.prefix, active)));
//        }
//        // 加载引入的yml
...
//            mapAll.putAll(yml2Map(StrUtil.format("{}/{}-{}.yml", classPath, this.prefix, inc)));
//        }
//        // 主配置覆盖其他配置
...
//            YAMLParser parser = yamlFactory.createParser(FileUtil.getUtf8Reader(path));
...
//        // 临时生成yml
//        String filePath = Tools.getRootPath() + "/temp.yml";
//        JsonParser parser;
